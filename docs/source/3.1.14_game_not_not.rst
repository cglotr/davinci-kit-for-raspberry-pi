...
Basierend auf 1.1.6 LED Dot Matrix fügt diese Lektion 2 Tasten hinzu, um ein amüsantes Spielgerät zu erstellen. Wenn Sie mit der Punktmatrix nicht sehr vertraut sind, lesen Sie bitte :ref:`matrix`.
...
Wenn Sie mit der Punktmatrix nicht sehr vertraut sind, lesen Sie bitte :ref:`matrix` .
