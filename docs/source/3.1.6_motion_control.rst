...
.. note::
    ...
    Se non funziona dopo l'esecuzione o appare un messaggio di errore come: \"wiringPi.h: No such file or directory\", consulta :ref:`faq_c_nowork`.
...
passo-passo, consulta :ref:`1.3.3_motor`.
