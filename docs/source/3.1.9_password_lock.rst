...
Voir :ref:`2.1.5_keypad` de ce document pour plus de détails.
...
:ref:`1.1.7_i2c_lcd` de ce document pour plus de détails.
...
Pour plus de détails, référez-vous à :ref:`2.1.5_keypad` de ce document.
