...
.. note::
    ...
    Se il programma non funziona o ricevi il messaggio di errore: \"wiringPi.h: No such file or directory\", consulta la sezione :ref:`faq_c_nowork`.
...
tastierino; consulta :ref:`2.1.5_keypad` di questo documento per ulteriori 
dettagli.
...
LCD1602; consulta :ref:`1.1.7_i2c_lcd` per maggiori dettagli.
...
Consulta :ref:`2.1.5_keypad` di questo documento per maggiori dettagli.
