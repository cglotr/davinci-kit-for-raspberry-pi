...
Displays. Refer to :ref:`1.1.5_4digit_c_pi5` of the document for more details. Here, we use the 
...
The codes are used to switch the timer on and off. Refer to :ref:`1.1.5_4digit_c_pi5` for more details. Here, when the timer returns to zero, colorState
