...
.. note::
    ...
    Si no funciona después de ejecutar el código, o si aparece un mensaje de error como: \"wiringPi.h: No such file or directory\", consulta la sección :ref:`faq_c_nowork`.
