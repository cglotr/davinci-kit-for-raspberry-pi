...
.. note::
   ...
   Si cela ne fonctionne pas après exécution ou si un message d'erreur du type : "wiringPi.h: No such file or directory" apparaît, veuillez consulter :ref:`faq_c_nowork`.
