...
Displays. Refer to :ref:`1.1.5_4digit` of the document for more details. Here, we use the 
...
The codes are used to switch the timer on and off. Refer to :ref:`1.1.5_4digit` for more details. Here, when the timer returns to zero, colorState
...
4-Digit 7-Segment. Refer to :ref:`1.1.5_4digit` of the document for more
