...
.. note::
    ...
    Si el programa no funciona después de ejecutarlo o aparece un mensaje de error que dice: "wiringPi.h: No such file or directory", consulta la sección :ref:`faq_c_nowork`.
