...
Dans cette expérience, un buzzer actif, un transistor NPN et une résistance de 1 kΩ sont utilisés. La résistance est placée entre la broche GPIO et la base du transistor pour le protéger. Lorsque le GPIO17 du Raspberry Pi est réglé sur un niveau bas (0 V), le transistor entre en saturation et conduit, ce qui permet au buzzer de sonner. Lorsque GPIO17 est à un niveau haut, le transistor est coupé et le buzzer reste silencieux.
