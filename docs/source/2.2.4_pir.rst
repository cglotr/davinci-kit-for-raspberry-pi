...
.. note::
    ...
    Si cela ne fonctionne pas après l'exécution, ou si une erreur apparaît: \"wiringPi.h: Aucun fichier ou répertoire de ce type", veuillez vous référer à :ref:`faq_c_nowork`.
...
référer à la section :ref:`1.1.2_rgb` pour plus de détails.
...
Ces lignes de code sont utilisées pour régler la couleur de la LED RVB, veuillez consulter :ref:`1.1.2_rgb` pour plus de détails.
