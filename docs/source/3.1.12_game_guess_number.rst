...
.. note::
   ...
   Si cela ne fonctionne pas après l'exécution ou si un message d'erreur s'affiche : "wiringPi.h: No such file or directory", veuillez vous référer à :ref:`faq_c_nowork`.
...
sections :ref:`1.1.7_i2c_lcd` et **2.1.5 Keypad**.
...
:ref:`1.1.7_i2c_lcd` et **2.1.5 Clavier**.
