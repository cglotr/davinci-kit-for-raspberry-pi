...
**Paso 2:** Configurar SPI (consulta el :ref:`spi_configuration` para más detalles. 
...
<<<<<<< HEAD
    * Después de ejecutar ``2.2.7_write.py``, primero debes escribir un mensaje, presionar ``Enter`` para confirmar y, finalmente, colocar tu tarjeta en el módulo RFID MFRC522 para completar la escritura.
=======
