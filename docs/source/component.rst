...
After opening the package, please check whether all components match the product description and ensure that every part is in good condition.

.. image:: img/component_list.jpg
    :width: 90%

This section provides an overview of each component included in the kit.  
For every item, you will find:

* A brief introduction  
* The working principle  
* The projects in which the component is used  
